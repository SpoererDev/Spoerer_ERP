    ...
    <div className="space-y-3 text-left">
      ...
      <div ref={filterHeaderRef} className="sticky top-16 z-30 bg-[#f8fafc]/95 backdrop-blur-md -mx-6 px-6 -mt-3 pt-3 pb-2 space-y-2 border-b border-slate-200/80 shadow-xs">
        ...
        <CollapsibleKpiBanner
          storageKey="spr_erp_kpi_crm"
          items={[
            {
              title: 'Clientes Principales',
              value: mainClients.length,
              color: 'blue',
              icon: 'domain',
            },
            {
            ...
            {
              title: 'Cobertura',
              value: mainClients.length > 0 ? (clients.length / mainClients.length).toFixed(1) : 0,
              color: 'teal',
              icon: 'share',
            },
          ]}
        ...
        {/* Filter and Sub-tabs Navigation Bar */}
        <div className="card-modern py-2.5 px-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          {/* Search Box and Clear Button */}
          <div className="flex items-center gap-2 flex-grow max-w-lg min-w-[240px]">
            ...
            {searchTerm && (
              <button 
                ...
                className="flex items-center gap-1.5 px-3 py-2 border border-slate-200 rounded-xl bg-white text-slate-700 hover:bg-slate-50 transition-all text-xs font-semibold cursor-pointer active:scale-95 whitespace-nowrap"
          ...
          {/* Sub-tabs Selector on the right */}
          <div className="flex bg-slate-100 p-1 rounded-xl border border-slate-200/80 shrink-0">
            ...
            >
              ...
              <span>Clientes con Razón Social</span>
            </button>
          </div>
        </div>
      </div>
